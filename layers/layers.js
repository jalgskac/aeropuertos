...
ol.proj.get("EPSG:4326").setExtent([-108.196989, -17.027994, -15.185081, 31.374989]);
var wms_layers = [];
...
lyr_ne_10m_airports_1.set('fieldLabels', {'name': 'inline label', 'abbrev': 'no label', 'iata_code': 'inline label', 'wikipedia': 'inline label', 'Clase': 'inline label', });
